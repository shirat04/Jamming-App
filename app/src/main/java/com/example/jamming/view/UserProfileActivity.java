 ...
 * - Edit profile (navigates to UpdateUserProfileActivity)
 * - Change password (sends reset email)
 * - Toggle notifications
 * - Logout
 * - Delete account
 *
 * Follows MVVM architecture - all business logic is in UserProfileViewModel.
 */
public class UserProfileActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupBase(R.menu.user_menu, R.layout.activity_user_profile);
    ...
    private void initViews() {
        ...
        // Progress indicators (add these to your layout)

...
public class UserProfileViewModel extends ViewModel {
    ...
    /**
     * Uploads a profile image to Firebase Storage and updates the user profile.
     *
    ...
    /**
     * Updates the notifications enabled setting for the user.
     *
    ...
    public void sendPasswordResetEmail() {
        ...
        authRepository.sendPasswordResetEmail(currentUser.getEmail())
                .addOnSuccessListener(v -> {
                    isLoading.setValue(false);
     ...
     * This includes:
     * 1. Deleting user profile from Firestore
    ...
    public void deleteAccount() {
        ...
        if (currentUser != null && currentUser.getProfileImageUrl() != null) {
            deleteProfileImageFromStorage(currentUser.getProfileImageUrl());
        }

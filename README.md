...
Testing:
Unit tests for ViewModels (with mocks / fake repositories)
...
Make sure you have a valid Google Maps API key and Firebase configuration.
Add your local google-services.json file to:
...
To run tests:
Use Android Studio’s Run Tests or Gradle test tasks.
